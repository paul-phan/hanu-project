var Login = function () {
    var e = function () {
        ...
        function e(e) {
            ...
            var r = $('<span><img src="dashboard/img/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>");
            return r
        }
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["dashboard/img/bg/1.jpg", "dashboard/img/bg/2.jpg", "dashboard/img/bg/3.jpg", "dashboard/img/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
