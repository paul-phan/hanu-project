var EcommerceProductsEdit = function () {
    var e = function () {
        var e = new plupload.Uploader({
            ...
            url: "http://backend-4c.dev/restapi/upload/upload_only",
            filters: {
                max_file_size: "10mb",
                mime_types: [{title: "Image files", extensions: "jpg,gif,png"}, {title: "Zip files", extensions: "zip"}]
            },
            flash_swf_url: "dashboard/js/Moxie.swf",
            silverlight_xap_url: "dashboard/js/Moxie.xap",
            init: {
                PostInit: function () {
        ...
        e.init({
            ...
            dataTable: {
                ...
                pageLength: 10,
                ajax: {url: "restapi/..../ecommerce_product_reviews.php"},
