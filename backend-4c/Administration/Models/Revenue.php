        ...
        if(1<=$month&&$month<=12) {
            ...
            switch ($month) {
                case 1:
                    ...
                    $sql = "SELECT SUM(order_product.total_price) FROM `order_product` WHERE order_product.updated BETWEEN '$startInterval' AND '$endInterval' AND order.product.status=5";
