<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red bold uppercase"> Thêm nhân viên
                                        </span>
        </div>
        <div class="actions">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                                <label for="dropdown" class="control-label col-md-3">Tên nhân viên<span class="required"> * </span></label>
                                <div class="col-md-7">
                                    <input placeholder="Nhập tên nhân viên..." type="text" class="form-control"
                                           name="employee_name"
                                           value="<?= !empty($form['employee_name']) ? $form['employee_name'] : '' ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input placeholder="Nhập số CMT/Hộ chiếu.." type="number" maxlength="6" class="form-control"
                                           name="authentication"
                                           value="<?= !empty($form['authentication']) ? $form['authentication'] : '' ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input placeholder="Nhập số điện thoại" type="number" class="form-control"
                                           name="phone"
                                           value="<?= !empty($form['phone']) ? $form['phone'] : '' ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-action">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button type="submit" class="btn green button-submit" id="bsubmit"> Thêm nhân viên
