                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_images">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>
                                    <a href="<?= UPLOAD_DIR . '/avatar/updatelater.jpg' ?>" class="fancybox-button"
                                       data-rel="fancybox-button">
                                        <img class="img-responsive" src="<?= UPLOAD_DIR . '/avatar/updatelater.jpg' ?>"
                                             alt="">
                                    </a>
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="image[images][1][label]"
                                           value="Thumbnail image"></td>
                                <td>
                                    <input type="text" class="form-control" name="image[images][1][sort_order]"
                                           value="1"></td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][1][image_type]" value="1"> </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][1][image_type]" value="2"> </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][1][image_type]" value="3" checked>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="image[images][2][label]"
                                           value="Product image #1"></td>
                                <td>
                                    <input type="text" class="form-control" name="image[images][2][sort_order]"
                                           value="1"></td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][2][image_type]" value="1"> </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][2][image_type]" value="2" checked>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][2][image_type]" value="3"> </label>
                                </td>
                                <td>
                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                        <i class="fa fa-times"></i> Remove </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="image[images][3][label]"
                                           value="Product image #2"></td>
                                <td>
                                    <input type="text" class="form-control" name="image[images][3][sort_order]"
                                           value="1"></td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][3][image_type]" value="1" checked>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][3][image_type]" value="2"> </label>
                                </td>
                                <td>
                                    <label>
                                        <input type="radio" name="image[images][3][image_type]" value="3"> </label>
                                </td>
                                <td>
                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                        <i class="fa fa-times"></i> Remove </a>
